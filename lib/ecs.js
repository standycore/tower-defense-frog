...
class Entity {
     ...
     * @param {new() => T} component as a string or as a class constructor, not an instance of a class
     * @param  {...any} componentArgs
     * @returns {T} as an new instance
     */
     ...
     * @template {Component<any>} T
     * @param {new() => T} componentName can be a string or a component constuctor, not an instance
     * @returns {T} the component instance or undefined if it is not in this entity
     */
    ...
    /**
     *
     * @param {constructor} componentName
     */
    as(componentName) {
     ...
     * @returns {Map<string, Component>} the component map
     */
    getComponents() {
