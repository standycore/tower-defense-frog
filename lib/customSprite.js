...
class CustomSprite extends AnimatedSprite {
    ...
    constructor(spritesheet, options = {}) {
        ...
        // create animation for full sprite sheet
        this.animations._default = {
            frames: spritesheet.data.frames.map((frame, i) => i),
            durations: spritesheet.data.frames.map((frame) => frame.duration)
        };
