...
class World extends Container {
    ...
    createPath(x, y, direction, length = 30, path = new Grid()) {
        ...
        if (direction) {
            ...
            // }
            possibleDirections.push(...this.directions);
        ...
        possibleDirections = possibleDirections.filter((direction) => {
            ...
            if (direction.x) {
                ...
                testOffsets.push(this.directions[0], this.directions[1]);

            } else if (direction.y) {

                testOffsets.push(this.directions[2], this.directions[3]);
        ...
        return this.createPath(newTile.x, newTile.y, undefined, --length, path);
